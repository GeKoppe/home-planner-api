...
public class SessionControllerTest {
        ...
        private final User u1 = new User(1L, "Test1", new BCryptPasswordEncoder(12).encode("test1"), Set.of());
        private final User u2 = new User(2L, "Test2", new BCryptPasswordEncoder(12).encode("test2"), Set.of());
